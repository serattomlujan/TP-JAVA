...
public class FactoryConexion {
	...
	public static FactoryConexion instancia;
...
public static FactoryConexion getInstancia(){
	if(FactoryConexion.instancia == null){ FactoryConexion.instancia=new FactoryConexion();}
...
public Connection getConn() throws SQLException,AppDataException{
	...
	}cantConn++; return conn;}
}


public void  releaseConn()throws SQLException{
	try{cantConn--; if(cantConn=0){conn.close();} catch(SQLException e){throw e;}}
}
